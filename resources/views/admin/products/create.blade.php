        ...
        <div class="col-lg-11 col-md-6 mb-md-0 mb-4 ">
            <div class="card">
                ...
                <div class="card-body px-0 pb-2">
                    <form action="{{ route('products.store') }}" method="post" class="row g-3 p-4"
                        ...
                        <div class="col-md-6">
                            <div class="input-group input-group-outline my-3">
                                ...
                                <input type="number" class="form-control" value="{{ old('original_price') }}"
                        ...
                        <div class="col-md-6">
                            <div class="input-group input-group-outline my-3">
                                ...
                                <input type="number" class="form-control" value="{{ old('tex') }}" name="tex"
                                    onfocus="focused(this)" onfocusout="defocused(this)">
                            </div>
                            @error('tex')
                                <small class="text-danger">{{ $message }}</small>
                        ...
                        <div class="col-md-12">
                            <div class="input-group input-group-outline my-3">
                                ...
                                <input type="text" class="form-control" value="{{ old('small_description') }}"
                        ...
                        <div class="col-md-6">
                            <div class="form-check">
                                <input class="form-check-input" name="trending" value="1" type="checkbox" id="trending">
                        ...
                        <div class="col-md-12">
                            <div class="input-group input-group-outline my-3">
                                ...
                                <input class="form-control" value="{{ old('meta_description') }}"
